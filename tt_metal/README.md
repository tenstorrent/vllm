...
> - To run the 27B gemma-3 model, set `MESH_DEVICE=T3K`, `--model "google/gemma-3-27b-it"`, `--multi_modal`, `--multi_image`, `--max_seqs_in_batch 32`, and `--override_tt_config '{"l1_small_size": 768, "fabric_config": "FABRIC_1D", "processor_config": {"use_fast": true, "do_convert_rgb": true}}'`.
