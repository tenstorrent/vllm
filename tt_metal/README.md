...
- `always_compat_sampling`: [true, false], default: false
...
> - To run the 27B gemma-3 model, set `MESH_DEVICE=T3K`, `--model "google/gemma-3-27b-it"`, `--multi_modal`, `--max_seqs_in_batch 32`, and `--override_tt_config '{"l1_small_size": 768, "fabric_config": "FABRIC_1D"}'`.
