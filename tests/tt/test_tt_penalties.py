from tests.tt.utils import RequestConfig, run_concurrent_batch, assert_varied, assert_deterministic
...
class TestRepetitionPenalty:
    ...
    def test_different_repetition_penalties(
        ...
        assert_varied(results, 2, "Varying penalty should at least influence the output somewhat.")
    ...
    def test_repetition_penalty_mixed_batch(
        ...
        assert_varied([no_penalty[0], with_penalty[0]], 2, "Penalty should change output.")
...
class TestPresencePenalty:
    ...
    def test_different_presence_penalties(
        ...
        results = run_concurrent_batch(tt_server, tt_model_name, configs)
        assert_varied(results, 2, "Different presence penalties should produce different outputs.")
...
class TestFrequencyPenalty:
    ...
    def test_different_frequency_penalties(
        ...
        results = run_concurrent_batch(tt_server, tt_model_name, configs)
        assert_varied(results, 2, "Different frequency penalties should produce different outputs.")
