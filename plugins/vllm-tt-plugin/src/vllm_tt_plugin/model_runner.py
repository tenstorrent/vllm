...
class TTModelRunner:
    def __init__(
        ...
        # In gathered DP, only rank 0 owns devices and samples. In standard DP
        # every rank is an independent engine that needs its own sampler.
        if (self.parallel_config.data_parallel_rank_local == 0
                or not TTPlatform.gathered_dp_mode):
